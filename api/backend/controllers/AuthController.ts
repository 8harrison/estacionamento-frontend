...
import type { UsuarioCreationAttributes } from '../models/Usuario'; // Importar interface
 // Importar interface
...
export class AuthController {
  ...
  // Método para login
  public login = asyncHandler(async (req: Request, res: Response, _next: NextFunction): Promise<void> => {
  ...
  public register = asyncHandler(async (req: Request, res: Response, _next: NextFunction): Promise<void> => {
  ...
  public getAll = asyncHandler(async (_req: Request, res: Response, _next: NextFunction): Promise<void> => {
    try {
  ...
  public getAllPorteiros = asyncHandler(async (_req: Request, res: Response, _next: NextFunction): Promise<void> => {
    try {
  ...
  public updateUserAsPorteiro = asyncHandler(async (req: Request, res: Response, _next: NextFunction): Promise<void> => {
    try {
  ...
  public updateUserAsAdm = asyncHandler(async (req: Request, res: Response, _next: NextFunction): Promise<void> => {
    try {
      const id = parseInt(req.params.id, 10);
      if (isNaN(id)) {
        res.status(400).json({ message: 'ID inválido.' });
